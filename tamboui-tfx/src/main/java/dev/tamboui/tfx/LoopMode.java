 ...
 * <p>
 * Loop modes control whether effects run once and complete, restart from
 * the beginning, or reverse direction for continuous animations.
 * <p>
 * <b>Usage:</b>
 * <pre>{@code
...
public enum LoopMode {
     ...
     * <p>
     * When the effect reaches its end, it resets to the beginning and
     * continues running. Looping effects never complete on their own.
     */
    LOOP,
     ...
     * <p>
     * When the effect reaches its end, it reverses and plays backwards.
     * When it reaches the beginning, it reverses again. This creates
     * a smooth back-and-forth animation. Ping-pong effects never
