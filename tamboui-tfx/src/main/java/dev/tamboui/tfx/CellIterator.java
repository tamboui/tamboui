 ...
 * specified rectangular region. It supports optional filtering via CellFilter
 * to selectively process cells based on their properties.
 * <p>
 * For optimal performance, prefer
 * {@link #forEachCell(java.util.function.BiConsumer)} over iterator-based
 * iteration when you don't need iterator combinators.
 */
public final class CellIterator implements Iterable<CellIterator.CellEntry> {
     ...
     * @param area
     *            The rectangular area to iterate over
     */
    ...
    /**
     * Creates a new CellIterator over the specified area of a buffer with
     * filtering.
     * 
     * @param buffer
     *            The buffer to iterate over
     ...
     *            The rectangular area to iterate over
     * @param filter
     *            The cell filter to apply (null means no filtering)
     */
     ...
     * <p>
     * The function receives the cell's position and the cell itself. To modify the
     * cell, use {@link Buffer#set(Position, Cell)}.
     * 
     * @param consumer
     *            A function that takes (Position, Cell) and processes each cell
     */
     ...
     *
     * @param consumer
     *            A function that takes (Position, MutableCell) and processes each
     *            cell
     * @deprecated Use {@link #forEachCellMutable(CellMutator)} instead for better
     *             performance
     */
    @Deprecated
     ...
     *
     * @param mutator
     *            A function that takes (x, y, MutableCell) and processes each cell
     */
     ...
     * <p>
     * This class is designed to be reused across iterations to avoid object
     * allocation. Call {@link #reset(int, int, Cell)} to prepare it for a new cell
     * position.
     */
    public static final class MutableCell {
        ...
        /**
         * Resets this mutable cell to a new position and cell value. This allows the
         * same MutableCell instance to be reused across iterations.
         *
         * @param x
         *            the x coordinate
         * @param y
         ...
         * <p>
         * Note: This creates a new Position object. Prefer using {@link #x()} and
         * {@link #y()} when possible to avoid allocation.
         *
         * @return the position
         */
        public Position position() {
         ...
         * <p>
         * This is more efficient than creating a Style and calling patchStyle when only
         * the foreground color needs to change.
         *
         * @param color
         ...
         * <p>
         * This is more efficient than creating a Style and calling patchStyle when only
         * the background color needs to change.
         *
         * @param color
