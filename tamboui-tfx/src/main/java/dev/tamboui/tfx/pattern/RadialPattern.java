...
/// **Key Concepts:**
///
/// <li>**Center Point:** The origin of the radial expansion, specified in
/// normalized coordinates (0.0-1.0) relative to the area
/// <li>**Distance Calculation:** Uses Euclidean distance from center to
/// determine effect strength at each cell
/// <li>**Transition Width:** Controls the gradient zone where the effect
/// transitions from inactive to active (in terminal cells)
///
///
///
///
