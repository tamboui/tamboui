...
/// **Key Concepts:**
///
/// - **Direction:** The cardinal direction of the sweep (horizontal or vertical)
/// <li>**Transition Width:** Controls the gradient zone where the effect transitions
/// from inactive to active (in terminal cells). Larger values create smoother,
/// more gradual transitions.
/// <li>**Position Calculation:** Uses cell position along the sweep axis to
...
///
///
/// **Note:** {@link dev.tamboui.tfx.SlidingWindowAlpha} is used by {@link dev.tamboui.tfx.effects.SweepShader}
