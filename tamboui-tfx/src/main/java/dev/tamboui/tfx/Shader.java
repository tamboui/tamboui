...
/// **Design Philosophy:**
///
/// <li>**Separation of Timing and Rendering:** The default {@link #process} method
/// handles timer updates, while {@link #execute} handles the actual rendering logic.
/// <li>**Flexible Configuration:** Shaders can be configured with filters, patterns,
/// color spaces, and areas through optional methods.
/// - **Composability:** Shaders can be copied and combined to create complex effects.
///
///
///
///
...
///
/// 1. Store an {@link EffectTimer} for timing control
/// 1. Implement {@link #execute} to perform the actual cell transformations
/// 1. Implement {@link #done()} to check if the effect is complete
/// 1. Implement {@link #copy()} to support effect composition
///
///
///
///
