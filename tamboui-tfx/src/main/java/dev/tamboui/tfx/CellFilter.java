...
/// **Design Philosophy:**
///
/// <li>**Composability:** Simple filters can be combined to create complex
/// selection patterns using {@code allOf}, {@code anyOf}, and {@code noneOf}.
/// <li>**Performance:** Filters are evaluated during cell iteration, allowing
/// effects to skip irrelevant cells efficiently.
/// <li>**Flexibility:** Supports both spatial (area, margin) and content-based
/// (color, text) filtering.
///
///
///
///
/// **Filter Types:**
///
/// - **Spatial:** {@code area}, {@code inner}, {@code outer}
/// - **Color:** {@code fgColor}, {@code bgColor}
/// - **Content:** {@code text}
/// - **Logical:** {@code allOf}, {@code anyOf}, {@code noneOf}
/// - **Special:** {@code all}, {@code none}
///
///
///
///
