 ...
 * frame-based animations) and provides a simpler API than
 * {@link java.time.Duration} for common effect timing operations.
 * <p>
 * <b>Design Philosophy:</b>
 * <p>
 * TFxDuration is designed for performance and simplicity in animation contexts:
 * <ul>
 * <li><b>Millisecond Precision:</b> Sufficient for 60fps animations (16ms per
 * frame)</li>
 * <li><b>Immutable:</b> All operations return new instances, ensuring thread
 * safety</li>
 * <li><b>Simple API:</b> Focused on common operations needed for effect
 * timing</li>
 * <li><b>No Negative Durations:</b> Enforces non-negative durations to prevent
 * errors</li>
 * </ul>
 * <p>
 * <b>Key Operations:</b>
 * <ul>
 * <li><b>Creation:</b> {@code fromMillis}, {@code fromSecs},
 * {@code fromSecsF32}</li>
 * <li><b>Arithmetic:</b> {@code add}, {@code sub}, {@code mul} (with overflow
 * protection)</li>
 * <li><b>Comparison:</b> {@code isZero}, {@code checkedSub} (returns null if
 * negative)</li>
 * <li><b>Conversion:</b> {@code asMillis}, {@code asSecsF32},
 * {@code toJavaDuration}</li>
 * </ul>
 * <p>
 * <b>Usage Pattern:</b>
 * 
 ...
 * </ul>
 * <p>
 * Conversion methods are provided for interoperability with
 * {@code java.time.Duration} when needed (e.g., for TuiConfig tick rates).
 */
public final class TFxDuration {
     ...
     * @return the result of the subtraction, or {@code null} if the result would be
     *         negative
     */
