 ...
 * <li><b>Frame Processing:</b> Processing all effects each frame with the
 * elapsed time</li>
 * <li><b>Lifecycle Management:</b> Automatically removing completed
 * effects</li>
 * <li><b>Performance Optimization:</b> Providing {@link #isRunning()} to
 * optimize render loops</li>
 * </ul>
 * <p>
 * <b>Design Philosophy:</b>
 * <p>
 * The EffectManager follows a "fire and forget" pattern. Once an effect is
 * added, it will be processed automatically each frame until completion, at
 * which point it is removed. This eliminates the need for manual effect
...
public final class EffectManager {
     ...
     * 
     * @param effect
     *            The effect to add to the manager
     */
     ...
     * returns {@code false} and there are no other state changes, the UI redraw can
     * be skipped.
     * 
     ...
     * <p>
     * This method should be called each frame in your render loop. It will: 1.
     * Process each effect for the specified duration 2. Remove completed effects
     * 
     * @param duration
     *            The time elapsed since the last frame
     * @param buffer
     *            The buffer to render effects into
     * @param area
     *            The area within which effects should be rendered
     */
