...
/// **Design Philosophy:**
///
/// <li>**Immutability:** All configuration methods return new Effect instances,
/// making effects safe to share and compose.
/// <li>**Separation of Concerns:** Effects handle configuration and lifecycle,
/// while Shaders handle the actual rendering logic.
/// - **Fluent API:** Method chaining allows for readable effect construction.
///
///
///
///
