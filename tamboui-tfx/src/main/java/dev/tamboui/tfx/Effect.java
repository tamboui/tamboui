 ...
 * (Shader) from the effect configuration (Effect), allowing effects to be
 * easily composed and customized without modifying the underlying shader.
 * <p>
 * <b>Design Philosophy:</b>
 * <ul>
 * <li><b>Immutability:</b> All configuration methods return new Effect
 * instances, making effects safe to share and compose.</li>
 * <li><b>Separation of Concerns:</b> Effects handle configuration and
 * lifecycle, while Shaders handle the actual rendering logic.</li>
 * <li><b>Fluent API:</b> Method chaining allows for readable effect
 * construction.</li>
 * </ul>
 * <p>
 * <b>Usage Pattern:</b>
...
public final class Effect {
     ...
     *
     * @param area
     *            The rectangular area where the effect will be applied
     ...
     * mutates the existing effect. This is useful for updating running effects when
     * elements move or resize.
     *
     * @param area
     *            The new area where the effect should be applied
     */
     ...
     * 
     * @param pattern
     *            The pattern to use for spatial effects
     ...
     * <p>
     * This method: 1. Updates the shader's timer with the given duration 2.
     * Executes the shader effect 3. Returns any overflow duration
     * 
     * @param duration
     *            The duration to process the effect for
     * @param buffer
     *            The buffer where the effect will be applied
     * @param area
     *            The rectangular area within the buffer where the effect will be
     *            applied
     ...
     * <p>
     * The copy has the same configuration (area, filter, color space, pattern, loop
     * mode) but its own independent timer state. This is useful when you need to
     * apply the same effect to multiple elements independently.
     *
     ...
     * <p>
     * This reverses the playback direction of the effect, causing it to play
     * backwards.
     * <p>
     * In Rust, this takes ownership and mutates in place, but in Java we create a
     * new immutable instance to match the behavior of EffectTimer.reversed().
     *
     ...
     * back-and-forth animation. Ping-pong effects never complete on their own and
     * must be manually removed or cleared from the effect manager.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>{@code
