...
/**
 * A shader that applies a stretching effect to terminal cells, expanding or
 * shrinking rectangular areas using block characters.
 * <p>
 * The stretch effect fills areas with a style (including background color) and
 * uses partial block characters (▏▎▍▌▋▊▉█ for horizontal, ▁▂▃▄▅▆▇█ for
 * vertical) to create smooth transitions as the area expands or contracts.
 */
public final class StretchShader implements Shader {
     ...
     *
     * @param style
     *            the style to apply to the stretched area
     * @param direction
     *            the direction of the stretch animation
     * @param timer
    ...
    private static Regions regions(Motion direction, float progress, Rect area) {
        switch (direction) {
            case LEFT_TO_RIGHT : {
                ...
                return new Regions(new Rect(area.left(), area.top(), filledWidth, area.height()),
            ...
            case RIGHT_TO_LEFT : {
                ...
                return new Regions(new Rect(filledX, area.top(), filledWidth, area.height()),
                        new Rect(stretchingX, area.top(), 1, area.height()),
            ...
            case UP_TO_DOWN : {
                ...
                return new Regions(new Rect(area.left(), area.top(), area.width(), filledHeight),
            ...
            case DOWN_TO_UP : {
                ...
                return new Regions(new Rect(area.left(), filledY, area.width(), filledHeight),
                        new Rect(area.left(), stretchingY, area.width(), 1),
