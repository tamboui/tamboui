 ...
 * them to combine visually (e.g., a fade effect combined with a dissolve
 * effect).
 * <p>
 * <b>Behavior:</b>
 * <ul>
 ...
 * <li>The parallel effect completes when all constituent effects have
 * completed</li>
 * </ul>
 * <p>
 * <b>Visual Layering:</b>
 * <p>
 * When multiple effects are applied in parallel, they are processed in the
 * order they were provided. Later effects may visually overwrite earlier
 * effects depending on their cell filters and rendering logic. Use cell filters
 * to control which cells each effect affects.
 * <p>
 * <b>Usage Pattern:</b>
 * 
 * <pre>{@code
 ...
 *         Fx.fadeToFg(Color.CYAN, 2000, Interpolation.SineInOut).withFilter(CellFilter.text()),
 *         Fx.dissolve(2500, Interpolation.QuadOut).withFilter(CellFilter.text()));
 * }</pre>
 * <p>
 * This shader is typically created through
 * {@link dev.tamboui.tfx.Fx#parallel(Effect...)} rather than directly.
 */
