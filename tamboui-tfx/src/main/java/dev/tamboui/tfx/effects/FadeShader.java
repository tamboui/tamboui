 ...
 * <ul>
 * <li><b>Color Interpolation:</b> Uses configurable color spaces (RGB, HSL,
 * HSV) for perceptually smooth transitions</li>
 * <li><b>Spatial Patterns:</b> Can apply fade patterns using {@link Pattern}
 * implementations for directional or radial fades</li>
 * <li><b>Cell Filtering:</b> Can target specific cells using
 * {@link CellFilter}</li>
 * </ul>
 * <p>
 * <b>Implementation Details:</b>
 * <p>
 * The shader iterates through cells in the target area, applies the cell
 * filter, and interpolates colors based on the timer's alpha value. If a
 * pattern is set, the pattern transforms the global alpha into
 * position-specific alpha values.
 * <p>
 ...
 * </ul>
 * <p>
 * This shader is typically created through {@link dev.tamboui.tfx.Fx} factory
...
public final class FadeShader implements Shader {
     ...
     *            the target color
     * @param timer
     *            the effect timer controlling the fade duration
