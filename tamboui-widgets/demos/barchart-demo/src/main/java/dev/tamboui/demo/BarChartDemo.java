...
public class BarChartDemo {
    ...
    private void renderHeader(Frame frame, Rect area) {
        Block headerBlock = Block.builder().borders(Borders.ALL).borderType(BorderType.ROUNDED)
                ...
                .title(Title.from(Line.from(Span.raw(" TamboUI ").bold().cyan(),
                        Span.raw("BarChart Demo ").yellow())).centered())
                .build();
    ...
    private void renderVerticalGroupedChart(Frame frame, Rect area) {
        var chart = BarChart
                .builder().data(
                        BarGroup.builder().label("Q1")
                                .addBar(Bar.builder().value(q1Sales[0]).label("Jan")
                                        .style(Style.EMPTY.fg(Color.RED)).build())
                                .addBar(Bar.builder().value(q1Sales[1]).label("Feb")
                                        .style(Style.EMPTY.fg(Color.GREEN)).build())
                                .addBar(Bar.builder().value(q1Sales[2]).label("Mar")
                                        .style(Style.EMPTY.fg(Color.BLUE)).build())
                                .build(),
                        BarGroup.builder().label("Q2")
                                .addBar(Bar.builder().value(q2Sales[0]).label("Apr")
                                        .style(Style.EMPTY.fg(Color.RED)).build())
                                .addBar(Bar.builder().value(q2Sales[1]).label("May")
                                        .style(Style.EMPTY.fg(Color.GREEN)).build())
                                .addBar(Bar.builder().value(q2Sales[2]).label("Jun")
                                        .style(Style.EMPTY.fg(Color.BLUE)).build())
                                .build(),
                        BarGroup.builder().label("Q3")
                                .addBar(Bar.builder().value(q3Sales[0]).label("Jul")
                                        .style(Style.EMPTY.fg(Color.RED)).build())
                                .addBar(Bar.builder().value(q3Sales[1]).label("Aug")
                                        .style(Style.EMPTY.fg(Color.GREEN)).build())
                                .addBar(Bar.builder().value(q3Sales[2]).label("Sep")
                                        .style(Style.EMPTY.fg(Color.BLUE)).build())
                                .build(),
                        BarGroup.builder().label("Q4")
                                .addBar(Bar.builder().value(q4Sales[0]).label("Oct")
                                        .style(Style.EMPTY.fg(Color.RED)).build())
                                .addBar(Bar.builder().value(q4Sales[1]).label("Nov")
                                        .style(Style.EMPTY.fg(Color.GREEN)).build())
                                .addBar(Bar.builder().value(q4Sales[2]).label("Dec")
                                        .style(Style.EMPTY.fg(Color.BLUE)).build())
                                .build())
                .barWidth(3).barGap(1).groupGap(2).max(250).valueStyle(Style.EMPTY.fg(Color.WHITE))
                ...
                .block(Block.builder().borders(Borders.ALL).borderType(BorderType.ROUNDED)
                        ...
                        .title(Title.from(Line
                                .from(Span.raw(" Quarterly Sales (Vertical Grouped) ").green())))
                        .build())
                .build();
    ...
    private void renderHorizontalChart(Frame frame, Rect area) {
        var chart = BarChart.builder()
                .data(BarGroup.of(
                        Bar.builder().value(q1Sales[0] + q1Sales[1] + q1Sales[2]).label("Q1")
                                .style(Style.EMPTY.fg(Color.CYAN)).build(),
                        Bar.builder().value(q2Sales[0] + q2Sales[1] + q2Sales[2]).label("Q2")
                                .style(Style.EMPTY.fg(Color.YELLOW)).build(),
                        Bar.builder().value(q3Sales[0] + q3Sales[1] + q3Sales[2]).label("Q3")
                                .style(Style.EMPTY.fg(Color.MAGENTA)).build(),
                        Bar.builder().value(q4Sales[0] + q4Sales[1] + q4Sales[2]).label("Q4")
                                .style(Style.EMPTY.fg(Color.GREEN)).build()))
                .direction(Direction.HORIZONTAL).barWidth(2).barGap(1).max(700)
                .valueStyle(Style.EMPTY.fg(Color.WHITE)).labelStyle(Style.EMPTY.fg(Color.YELLOW))
                .block(Block.builder().borders(Borders.ALL).borderType(BorderType.ROUNDED)
                        .borderStyle(Style.EMPTY.fg(Color.MAGENTA))
                        .title(Title.from(
                                Line.from(Span.raw(" Quarterly Totals (Horizontal) ").magenta())))
                        .build())
                .build();
    ...
    private void renderSimpleChart(Frame frame, Rect area) {
        var chart = BarChart.builder()
                .data(BarGroup.of(Bar.of(q1Sales[0], "Jan"), Bar.of(q1Sales[1], "Feb"),
                        Bar.of(q1Sales[2], "Mar"), Bar.of(q2Sales[0], "Apr"),
                        Bar.of(q2Sales[1], "May"), Bar.of(q2Sales[2], "Jun")))
                .barWidth(5).barGap(1).max(250).barStyle(Style.EMPTY.fg(Color.CYAN))
                .valueStyle(Style.EMPTY.fg(Color.WHITE)).labelStyle(Style.EMPTY.fg(Color.YELLOW))
                .block(Block.builder().borders(Borders.ALL).borderType(BorderType.ROUNDED)
                        .borderStyle(Style.EMPTY.fg(Color.CYAN))
                        .title(Title.from(Line.from(Span.raw(" Monthly Sales (Simple) ").cyan())))
                        .build())
                .build();
    ...
    private void renderFooter(Frame frame, Rect area) {
        ...
        Line helpLine = Line.from(Span.raw(" Chart: ").dim(), Span.raw(chartName).bold().cyan(),
                Span.raw("   "), Span.raw("1-3").bold().yellow(), Span.raw(" Switch  ").dim(),
                Span.raw("r").bold().yellow(), Span.raw(" Randomize  ").dim(),
