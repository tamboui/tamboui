...
class AxisTest {
    ...
    void builder_title_string() {
        Axis axis = Axis.builder().title("X Axis").build();
    ...
    void builder_title_line() {
        ...
        Axis axis = Axis.builder().title(line).build();
    ...
    void builder_title_spans() {
        Axis axis = Axis.builder()
                .title(Span.styled("X", Style.EMPTY.fg(Color.RED)), Span.raw(" Axis")).build();
    ...
    void builder_title_null_clears_title() {
        Axis axis = Axis.builder().title("Test").title((String) null).build();
    ...
    void builder_bounds_min_max() {
        Axis axis = Axis.builder().bounds(0, 100).build();
    ...
    void builder_bounds_array() {
        Axis axis = Axis.builder().bounds(new double[]{-50, 50}).build();
    ...
    void builder_bounds_null_keeps_default() {
        Axis axis = Axis.builder().bounds(null).build();
    ...
    void builder_labels_strings() {
        Axis axis = Axis.builder().labels("0", "25", "50", "75", "100").build();
    ...
    void builder_labels_spans() {
        ...
        Axis axis = Axis.builder().labels(span1, span2).build();
    ...
    void builder_labels_list() {
        ...
        Axis axis = Axis.builder().labels(labels).build();
    ...
    void builder_labels_null_clears_labels() {
        Axis axis = Axis.builder().labels("1", "2", "3").labels((String[]) null).build();
    ...
    void builder_addLabel_string() {
        Axis axis = Axis.builder().addLabel("First").addLabel("Second").build();
    ...
    void builder_addLabel_span() {
        ...
        Axis axis = Axis.builder().addLabel(span).build();
    ...
    void builder_style() {
        ...
        Axis axis = Axis.builder().style(style).build();
    ...
    void builder_labelsAlignment() {
        Axis axis = Axis.builder().labelsAlignment(Alignment.CENTER).build();
    ...
    void builder_labelsAlignment_null_defaults_to_left() {
        Axis axis = Axis.builder().labelsAlignment(null).build();
    ...
    void labels_returns_immutable_list() {
        Axis axis = Axis.builder().labels("A", "B", "C").build();
