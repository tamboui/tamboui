...
/**
 * Base interface for all DSL elements. Elements represent UI components that
 * can be rendered to a frame.
 * <p>
 * Elements can handle events by implementing event handler methods or by
 * registering handler lambdas. Events propagate through the element tree and
 * can be consumed to stop propagation.
 */
public interface Element {
    ...
    /**
     * Returns the layout constraint for this element, if any. Used by container
     * elements to determine sizing.
     *
    ...
    /**
     * Returns the preferred width of this element in cells. Used when the element
     * has a {@link Constraint.Fit} constraint.
     *
    ...
    /**
     * Returns the preferred height of this element in cells. Used when the element
     * has a {@link Constraint.Fit} constraint.
     *
    ...
    /**
     * Returns the preferred height of this element given an available width and
     * render context.
     * <p>
     ...
     * height calculation where properties like {@code text-overflow} may be set via
     * CSS.
     * <p>
     * When context is null, implementations should use programmatic property values
     * only.
     *
     * @param availableWidth
     *            the available width in cells
     * @param context
     *            the render context for CSS resolution, may be null
    ...
    /**
     * Returns the unique ID of this element, if set. Used for focus management and
     * state tracking.
     *
    ...
    /**
     * Handles a key event on this element. Override to handle key events directly
     * on the element.
     *
     * @param event
     *            the key event
    ...
    /**
     * Handles a mouse event on this element. Override to handle mouse events
    ...
    /**
     * Returns the last rendered area of this element. Used for hit testing and
     * event routing.
     *
