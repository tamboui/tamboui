 ...
 * 
 * <pre>{@code
 * textArea(textState).placeholder("Enter text...").title("Description").showLineNumbers().rounded()
 * }</pre>
 *
 ...
 * <ul>
 * <li>{@code TextAreaElement-cursor} - The cursor style (default:
 * reversed)</li>
 * <li>{@code TextAreaElement-placeholder} - The placeholder text style
 * (default: dim)</li>
 * <li>{@code TextAreaElement-line-number} - The line number style (default:
 * dim)</li>
 * </ul>
 * <p>
 * Example CSS:
...
public final class TextAreaElement extends StyledElement<TextAreaElement> {
     ...
     *
     * @param state
     *            the text area state, or null for a default state
     */
    ...
    /**
     * Sets the border color to use when focused. If not set, no special focused
     * border styling is applied (CSS :focused pseudo-class can be used instead).
     *
     * @param color
     ...
     * <p>
     * Note: The {@code focused} parameter is informational only. If the event
     * reached this element, it should be processed.
     */
    @Override
    ...
    protected void renderContent(Frame frame, Rect area, RenderContext context) {
        ...
        TextArea.Builder builder = TextArea.builder().style(context.currentStyle())
                .cursorStyle(effectiveCursorStyle).placeholder(placeholder)
                .placeholderStyle(effectivePlaceholderStyle).showLineNumbers(showLineNumbers)
