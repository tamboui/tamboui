...
class TerminalImageCapabilitiesTest {
    ...
    void bestSupport_returns_highest_priority() {
        TerminalImageCapabilities caps = TerminalImageCapabilities
                .withSupport(EnumSet.of(TerminalImageProtocol.SIXEL,
                        TerminalImageProtocol.HALF_BLOCK, TerminalImageProtocol.BRAILLE));
    ...
    void bestSupport_prefers_kitty_over_iterm2() {
        TerminalImageCapabilities caps = TerminalImageCapabilities
                .withSupport(EnumSet.of(TerminalImageProtocol.KITTY, TerminalImageProtocol.ITERM2));
    ...
    void supportsNativeImages_true_for_iterm2() {
        TerminalImageCapabilities caps = TerminalImageCapabilities
                .withSupport(EnumSet.of(TerminalImageProtocol.ITERM2));
    ...
    void bestProtocol_returns_half_block_for_half_block_support() {
        TerminalImageCapabilities caps = TerminalImageCapabilities
                .withSupport(EnumSet.of(TerminalImageProtocol.HALF_BLOCK));
    ...
    void bestProtocol_returns_braille_for_braille_support() {
        TerminalImageCapabilities caps = TerminalImageCapabilities
                .withSupport(EnumSet.of(TerminalImageProtocol.BRAILLE));
    ...
    void protocolFor_returns_correct_protocol() {
        ...
        assertThat(caps.protocolFor(TerminalImageProtocol.HALF_BLOCK))
                .isInstanceOf(HalfBlockProtocol.class);
        assertThat(caps.protocolFor(TerminalImageProtocol.BRAILLE))
                .isInstanceOf(BrailleProtocol.class);
    ...
    void protocolFor_returns_native_protocols() {
        ...
        assertThat(caps.protocolFor(TerminalImageProtocol.ITERM2))
                .isInstanceOf(ITermProtocol.class);
