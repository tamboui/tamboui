...
| `tamboui-markdown`    | Markdown renderer (CommonMark + GFM; opt-in CommonMark dep; Java 11) |
| `tamboui-toolkit-markdown` | Toolkit DSL element wrapping `MarkdownView` (Java 11) |
