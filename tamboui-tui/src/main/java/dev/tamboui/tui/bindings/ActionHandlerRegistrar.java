 ...
 * discovered via {@link java.util.ServiceLoader} and used to wire up action
 * handlers automatically.
 *
 * <pre>{@code
 * // Generated for a class with @OnAction methods:
 * public final class MyApp_ActionHandlerRegistrar implements ActionHandlerRegistrar<MyApp> {
 *
 *     &#64;Override
 ...
 *
 * @param <T>
 *            the type of object containing the annotated methods
...
public interface ActionHandlerRegistrar<T> {
     ...
     * @param handler
     *            the handler to register actions with
     */
