 ...
 * Architecture:
 * <ul>
 * <li>{@link FileManagerController} - Application state and file
 * operations</li>
 * <li>{@link DirectoryBrowserController} - Single directory browsing state</li>
 * <li>{@link FileManagerView} - Main UI composition and browser panel
 * rendering</li>
 ...
 * <li>F8/D - Delete</li>
 * <li>V - View file (text files show in scrollable paragraph, PNG images show
 * in Image widget)</li>
 * <li>R - Refresh</li>
 * <li>Q - Quit</li>
 * </ul>
...
public class FileManagerDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Run the application
        TuiConfig config = TuiConfig.builder().tickRate(Duration.ofMillis(50)).build();
