...
public final class StandardProperties {
    ...
    /**
     * The {@code color} property for foreground/text color. This property is
     * inheritable - children inherit their parent's color.
     */
    public static final PropertyDefinition<Color> COLOR = PropertyDefinition
            .builder(NAME_COLOR, ColorConverter.INSTANCE).inheritable().build();

    /**
     * The {@code text-style} property for text modifiers. This property is
     * inheritable - children inherit their parent's text style.
     */
    public static final PropertyDefinition<Set<Modifier>> TEXT_STYLE = PropertyDefinition
            .builder(NAME_TEXT_STYLE, ModifierConverter.INSTANCE).inheritable().build();
    ...
    /**
     * The {@code background} property for background color. This property is NOT
     * inheritable per CSS spec.
     */
    public static final PropertyDefinition<Color> BACKGROUND = PropertyDefinition
            .of(NAME_BACKGROUND, ColorConverter.INSTANCE);

    /**
     * The {@code background-color} property (alias for background). This property
     * is NOT inheritable per CSS spec.
     */
    public static final PropertyDefinition<Color> BACKGROUND_COLOR = PropertyDefinition
            .of(NAME_BACKGROUND_COLOR, ColorConverter.INSTANCE);

    /**
     * The {@code padding} property for inner spacing. This property is NOT
     * inheritable. Default: {@link Padding#NONE}
     */
    public static final PropertyDefinition<Padding> PADDING = PropertyDefinition
            .builder(NAME_PADDING, PaddingConverter.INSTANCE).defaultValue(Padding.NONE).build();

    /**
     * The {@code margin} property for outer spacing. This property is NOT
     * inheritable. Default: {@link Margin#NONE}
     */
    public static final PropertyDefinition<Margin> MARGIN = PropertyDefinition
            .builder(NAME_MARGIN, MarginConverter.INSTANCE).defaultValue(Margin.NONE).build();

    /**
     * The {@code text-align} property for text alignment. This property is NOT
     * inheritable. Default: {@link Alignment#LEFT}
     */
    public static final PropertyDefinition<Alignment> TEXT_ALIGN = PropertyDefinition
            .builder(NAME_TEXT_ALIGN, AlignmentConverter.INSTANCE).defaultValue(Alignment.LEFT)
            .build();

    /**
     * The {@code flex} property for flex layout mode. This property is NOT
     * inheritable.
     */
    public static final PropertyDefinition<Flex> FLEX = PropertyDefinition.of(NAME_FLEX,
            FlexConverter.INSTANCE);

    /**
     * The {@code direction} property for layout direction. This property is NOT
     * inheritable.
     */
    public static final PropertyDefinition<Direction> DIRECTION = PropertyDefinition
            .of(NAME_DIRECTION, DirectionConverter.INSTANCE);

    /**
     * The {@code spacing} property for gap between elements. This property is NOT
     * inheritable.
     */
    public static final PropertyDefinition<Integer> SPACING = PropertyDefinition.of(NAME_SPACING,
            IntegerConverter.INSTANCE);

    /**
     * The {@code width} property for element width constraint. Supports: fill, fit,
     * percentages (50%), fixed lengths (20), min/max, ratios (1/3). This property
     * is NOT inheritable.
     */
    public static final PropertyDefinition<Constraint> WIDTH = PropertyDefinition.of(NAME_WIDTH,
            ConstraintConverter.INSTANCE);

    /**
     * The {@code height} property for height constraint. This property is NOT
     * inheritable.
     */
    public static final PropertyDefinition<Constraint> HEIGHT = PropertyDefinition.of(NAME_HEIGHT,
            ConstraintConverter.INSTANCE);

    /**
     * The {@code text-overflow} property for text wrapping/truncation behavior.
     * This property is NOT inheritable. Default: {@link Overflow#CLIP}
     */
    public static final PropertyDefinition<Overflow> TEXT_OVERFLOW = PropertyDefinition
            .builder("text-overflow", OverflowConverter.INSTANCE).defaultValue(Overflow.CLIP)
            .build();
     ...
     *
     * @param name
     *            the property name (e.g., "color", "padding")
