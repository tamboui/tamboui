...
public final class Style {
    ...
    public static final Style EMPTY = new Style(null, null, null, EnumSet.noneOf(Modifier.class),
            EnumSet.noneOf(Modifier.class), Collections.emptyMap());
     ...
     *            the underline color, or null
     * @param addModifiers
     *            the modifiers to add
     * @param subModifiers
     *            the modifiers to subtract
     */
    public Style(Color fg, Color bg, Color underlineColor, EnumSet<Modifier> addModifiers,
     ...
     */
    public Style(Color fg, Color bg, Color underlineColor, EnumSet<Modifier> addModifiers,
            EnumSet<Modifier> subModifiers, Map<Class<?>, Object> extensions) {
        this.fg = fg;
        this.bg = bg;
        ...
        this.extensions = extensions.isEmpty()
     ...
     *            the underline color
     * @param addModifiers
     *            the modifiers to add (must be an isolated copy)
     * @param subModifiers
     *            the modifiers to subtract (must be an isolated copy)
     * @param extensions
     *            the extensions map (must be unmodifiable or empty)
     * @param skipCopy
     *            marker parameter to distinguish from public constructor
     */
    @SuppressWarnings("unused")
    private Style(Color fg, Color bg, Color underlineColor, EnumSet<Modifier> addModifiers,
            EnumSet<Modifier> subModifiers, Map<Class<?>, Object> extensions, boolean skipCopy) {
        this.fg = fg;
        this.bg = bg;
        this.underlineColor = underlineColor;
     ...
     *
     * @param color
     *            the foreground color, or null to leave unset
     ...
     *
     * @param color
     *            the background color, or null to leave unset
     * @return a new style instance
     */
     ...
     *
     * @param color
     *            the underline color, or null to leave unset
     * @return a new style instance
     */
    ...
    /**
     * Returns a new style with the given modifier enabled. If the modifier was
     * previously removed (subtracted), it is added back.
     *
     * @param modifier
     *            the modifier to enable
    ...
    /**
     * Returns a new style with the given modifier removed (subtracted). If the
     * modifier was previously added, it is removed.
     *
     * @param modifier
    ...
    /**
     * Returns a new style with the given hyperlink and ID. The ID can be used to
     * group multiple cells into a single link.
     *
     * @param url
     *            the URL for the hyperlink
     * @param id
    ...
    /**
     * Returns a new style with the given extension property set. Extensions allow
     * modules to attach additional data to styles without coupling.
     *
     * @param type
     *            the extension type (class)
     * @param value
     *            the extension value
     * @param <T>
    ...
    /**
     * Combines this style with another. The other style's values override this
     * style's values where they are set; null values in {@code other} leave the
     * current value unchanged.
     *
     * @param other
     *            the style to overlay
    ...
    public Style patch(Style other) {
        ...
        Color newUnderlineColor = other.underlineColor != null
        ...
        if (other.addModifiers.isEmpty() && other.subModifiers.isEmpty()) {
            // No modifier changes - reuse existing sets (safe because EnumSets are
            // defensively copied in constructor)
     ...
     * <p>
     * Named foreground colors contribute their name (e.g., "red"), Named background
     * colors contribute "bg-" + name (e.g., "bg-red"), and modifiers contribute
     * their {@link Modifier#implicitStyleName()} (e.g., "bold").
     *
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(fg, style.fg) && Objects.equals(bg, style.bg)
                && Objects.equals(underlineColor, style.underlineColor)
                && addModifiers.equals(style.addModifiers)
                && subModifiers.equals(style.subModifiers) && extensions.equals(style.extensions);
    }
    ...
    public String toString() {
        if (extensions.isEmpty()) {
            return String.format(
                    "Style[fg=%s, bg=%s, underlineColor=%s, addModifiers=%s, subModifiers=%s]", fg,
                    bg, underlineColor, addModifiers, subModifiers);
        }
        return String.format(
