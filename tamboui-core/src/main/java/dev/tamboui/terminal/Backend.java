...
/**
 * Backend interface for terminal operations. Implementations handle the actual
 * terminal I/O.
 */
public interface Backend extends AutoCloseable {
     ...
     * @throws IOException
     *             if setting the cursor position fails
     */
     ...
     *
     * @throws IOException
     *             if entering alternate screen fails
     */
     ...
     *
     * @throws IOException
     *             if leaving alternate screen fails
     */
     ...
     *
     * @throws IOException
     *             if enabling mouse capture fails
     */
     ...
     *
     * @throws IOException
     *             if disabling mouse capture fails
     */
     ...
     * <p>
     * This is used for native image protocols (Sixel, Kitty, iTerm2) that require
     * sending escape sequences with binary data.
     *
     * @param data
     ...
     * <p>
     * This is a convenience method for protocols that work with ASCII escape
     * sequences.
     *
     * @param data
     *            the string to write
    ...
    /**
     * Deletes N lines at the current cursor position, pulling lines below up. The
    ...
    /**
     * Moves the cursor up by N lines. If the cursor is already at the top, this has
     * no effect.
     *
     * @param n
    ...
    /**
     * Moves the cursor left by N columns. If the cursor is already at the leftmost
     * position, this has no effect.
     *
     * @param n
    ...
    /**
     * Erases from the cursor to the end of the line. The cursor position does not
     * change.
     *
     * @throws IOException
     *             if the operation fails
