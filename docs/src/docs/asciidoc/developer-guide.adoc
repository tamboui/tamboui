...
* `codeFormat(String)` — SVG template with placeholders (advanced)
...
* `codeFormat(String)` — HTML template with placeholders `{code}`, `{stylesheet}`, `{foreground}`, `{background}` (advanced)
